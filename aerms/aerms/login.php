...
<html lang="en">
  <head>
    <title>Agriculture Equipment Rental Management Sysytem</title>
    <meta charset="utf-8">
            ...
            <form class="bg-white p-5 contact-form" method="post">
             <h3>Login Page!!!</h3>
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Email or Mobile Number" name="emailcont" required="true">
              </div>
